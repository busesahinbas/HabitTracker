...
//    Habit(name: "Read Philosophy", isCompleted: false, period: Period(monthly: 10), frequencyType: .custom([2, 4, 6])),
//    Habit(name: "Journaling", isCompleted: true, period: Period(weekly: 7), frequencyType: .everyday)
//]
